from Couches.views import LocationUpdate, LocationCreate, LocationDelete, LocationDetail
...
urlpatterns = patterns('',
                       ...
                       url(r'^location_detail/(?P<pk>\d+)/$', LocationDetail.as_view(), name='couches-location-detail'),
