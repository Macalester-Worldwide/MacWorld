...
urlpatterns = patterns('',
    ...
    url(r'^profile/create/$', ProfileCreateView.as_view(), name='couches_profile.create'),
    url(r'^profile/(?P<username>.+)/edit/$', ProfileUpdateView.as_view(), name='couches_profile.update'),
    url(r'^profile/(?P<username>.+)/$', ProfileDetailView.as_view(), name='couches_profile.detail'),
